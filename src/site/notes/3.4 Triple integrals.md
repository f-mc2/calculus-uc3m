---
{"dg-publish":true,"permalink":"/3-4-triple-integrals/","created":"2023-08-24T17:06:55.944+02:00","updated":"2023-11-17T00:28:55.220+01:00"}
---
...
Without discussing technical details, we write down a magnificent theorem that helps us in computing $\mathrm{V}(S_{B}^{f})$ for a huge class of functions.
...
>$$
>\iiint_{W}\left(\mathrm{e}^{x^{2} + y^{2} + z^{1}}\right)^{\frac{3}{2}}\,\mathrm{d}V 
>$$
