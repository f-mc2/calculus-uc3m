---
{"dg-publish":true,"permalink":"/1-7-exercises/","created":"2024-02-16T21:53:46.266+01:00","updated":"2024-09-11T17:39:34.591+02:00"}
---
...
4) Consider the function $([0,+\infty),\mathbb{R},f,\mathbb{R})$, where $f(x)=x^{\frac{1}{n}}\equiv\sqrt[n]{x}$ with $n>1$: 
	...
	>[!note]- Solution 
	>1) We start noting that $([0,+\infty),\mathbb{R},f,\mathbb{R})$ is the [[1.1 Sets and functions#^ac035a\|inverse function]] of $([0,+\infty),\mathbb{R},g,\mathbb{R})$ where $g(y)=y^{n}$.  In exercise 2) above, we proved that $((-\infty,+\infty),\mathbb{R},g,\mathbb{R})$ is continuous. Therefore, $((0,+\infty),\mathbb{R},g,\mathbb{R})$ is continuous, and its inverse function $((0,+\infty),\mathbb{R},f,\mathbb{R})$ is continuous ([[1.2 Limits of scalar functions#^0478fa\|see here]]). The continuity of $([0,+\infty),\mathbb{R},f,\mathbb{R})$  at $0$ can be proved applying the [[1.2 Limits of scalar functions#^cbf378\|very definition of limit]]. 
...
2) Check the following limits:
	...
	>	5) To verify the limit, it suffices to use [[1.5\|1.5]]
