---
{"dg-publish":true,"permalink":"/1-7-exercises/","created":"2023-07-02T17:05:44.464+02:00","updated":"2023-09-20T17:27:48.100+02:00"}
---
...
1) Prove the following limits 
	...
	>2) For $|x|< 1$, the sequence $a_{n}=x^{n}$ has limit either $0$. Therefore, exploiting the result of point 1) together with the algebraic manipulations of limits of sequences, the desired result follows. When $x=1$, the sequence $a_{n}=1^n$ has limit $1$. Reasoning as before, the result follows. When $x=-1$,  the sequence $a_{n}=(-1)^n$ has no limit. However, $\mid \frac{(-1)^n}{n!}\mid=\mid \frac{1}{n!}\mid$, and we know that 
